...
@section('title', 'Ajouter une échéance - Espace commercial')

@section('content')
<div class="mx-auto max-w-5xl px-6 py-8">
    <div class="mb-6">
        <a href="{{ $selectedContract ? route('commercial.contracts.show', $selectedContract) : route('commercial.payments.index') }}"
    ...
    <form method="POST"
          action="{{ route('commercial.payments.store') }}"
                        ...
                        @else
                            ...
                            @if($contracts->isEmpty())
                                <p class="mt-2 text-xs text-amber-700">
                                    Aucun contrat disponible dans votre périmètre commercial.
                                </p>
                            @endif
                        @endif
                    </div>
