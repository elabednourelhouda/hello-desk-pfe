...
@section('title', 'Paiements - Espace commercial')
    ...
    <div class="mx-auto max-w-7xl px-6 py-8">
            ...
            <div class="grid gap-0 lg:grid-cols-[1.35fr_0.65fr]">
                <div class="bg-gradient-to-br from-[#284625] via-[#315f32] to-[#4b7f3f] p-8 text-white">
                    ...
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-white/80">
                        Un contrat par ligne, limité à votre périmètre commercial. Ouvrez
                        l'échéancier d'un contrat pour le détail mois par mois.
                    </p>

                    <div class="mt-6 flex flex-wrap gap-3">
                        @if($hasCommercialScope ?? true)
                            <a href="{{ route('commercial.payments.create') }}"
                        ...
                        @else
                            <span class="inline-flex h-11 items-center justify-center rounded-xl bg-white/20 px-5 text-sm font-bold text-white/70">
                                Affectation requise
                            </span>
                        @endif
        ...
        @if(isset($hasCommercialScope) && ! $hasCommercialScope)
            <div class="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-800">
                Vous n'avez aucune affectation active. Les contrats apparaîtront ici après votre affectation à un site ou à un étage.
            </div>
        @endif
        ...
        <section class="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('commercial.payments.index') }}#payments-list"
            ...
            <form id="paymentFilters"
                  method="GET"
                  action="{{ route('commercial.payments.index') }}#payments-list"
                            ...
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end">
                                        <a href="{{ route('commercial.payments.schedule', $contract) }}"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-14 text-center">
                                    <div class="mx-auto max-w-sm">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            Ajoutez une échéance pour suivre les paiements des clients de votre périmètre.
                                        </p>
                                        ...
                                        @else
                                            <span class="mt-5 inline-flex h-10 items-center justify-center rounded-xl bg-gray-100 px-4 text-sm font-bold text-gray-500">
                                                Affectation requise
                                            </span>
                                        @endif
                                    </div>
