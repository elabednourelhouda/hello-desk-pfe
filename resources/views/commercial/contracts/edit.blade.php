...
@section('title', 'Modifier contrat - Espace commercial')
...
<div class="mx-auto max-w-4xl px-6 py-8">
    ...
    <form method="POST"
          action="{{ route('commercial.contracts.update', $contract) }}"
        ...
        <div class="grid gap-5 md:grid-cols-2">
            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-semibold text-gray-700">
                    Titre du contrat <span class="text-red-500">*</span>
                </label>
        ...
        <div class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
            ...
            <p class="mt-1">
                Pour activer un contrat, le dossier juridique du client doit être complet et le PDF signé doit être importé.
            </p>
        </div>
