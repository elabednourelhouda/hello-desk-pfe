...
@section('title', 'Contrats - Espace commercial')
    ...
    <div class="mx-auto max-w-7xl px-6 py-8">
            ...
            <div class="grid gap-0 lg:grid-cols-[1.35fr_0.65fr]">
                <div class="bg-gradient-to-br from-[#284625] via-[#315f32] to-[#4b7f3f] p-8 text-white">
                    ...
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-white/80">
                        Consultez les contrats liés aux réservations de votre périmètre commercial,
                        vérifiez leur statut et suivez les documents PDF importés.
                    </p>
        ...
        @if(isset($hasCommercialScope) && ! $hasCommercialScope)
            <div class="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-800">
                Vous n’avez aucune affectation active. Les contrats apparaîtront ici après votre affectation à un campus ou à un étage.
            </div>
        @endif
        ...
        <section class="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('commercial.contracts.index') }}#contracts-list"
            ...
            <form id="contractFilters"
                  method="GET"
                  action="{{ route('commercial.contracts.index') }}#contracts-list"
            ...
            <div class="border-b border-gray-100 px-6 py-5">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Chaque contrat est lié à un client et à une réservation de votre périmètre.
                        </p>
                    </div>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-14 text-center">
                                    <div class="mx-auto max-w-sm">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            Les contrats seront créés depuis les réservations de votre périmètre commercial.
                                        </p>
