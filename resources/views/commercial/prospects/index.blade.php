            ...
            <div class="grid gap-0 lg:grid-cols-[1.35fr_0.65fr]">
                <div class="bg-gradient-to-br from-[#284625] via-[#315f32] to-[#4b7f3f] p-8 text-white">
                    ...
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-white/80">
                        Suivez les prospects de votre périmètre, analysez leur avancement commercial
                        et accédez rapidement aux dossiers CRM.
                    </p>
                ...
                <div class="bg-white p-8">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Répartition de vos prospects accessibles.
                    </p>
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div>
                            <div class="mb-2 flex justify-between text-sm">
                                <span class="font-semibold text-gray-600">abandonné</span>
            ...
            <div class="border-b border-gray-100 px-6 py-5">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Cette liste affiche uniquement les prospects accessibles à votre compte commercial.
                        </p>
                    </div>
                        ...
                        <tr class="transition hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a href="{{ route('commercial.prospects.crm', ['prospect' => $prospect, 'return_url' => request()->fullUrl()]) }}"
