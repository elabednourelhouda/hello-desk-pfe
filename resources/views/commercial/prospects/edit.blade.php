...
@section('title', 'Modifier un prospect - Commercial')
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-5xl px-6 py-8">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <a href="{{ route('commercial.prospects.show', $prospect) }}"
               class="text-sm font-semibold text-[#284625] hover:underline">
                ← Retour au dossier prospect
            </a>
            ...
            <p class="mt-2 text-sm text-gray-500">
                Mettez à jour les informations commerciales de ce prospect.
            </p>
        </div>
        ...
        {{-- Form card --}}
        <form method="POST"
              action="{{ route('commercial.prospects.update', $prospect) }}"
                    ...
                    <div>
                        ...
                        <select name="crm_status"
                            ...
                            @foreach($statuses as $key => $label)
                                <option value="{{ $key }}"
                                        @selected(old('crm_status', $prospect->crm_status) === $key)>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
