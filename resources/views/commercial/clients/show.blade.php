...
@section('title', 'Détail client - Commercial')
            ...
            <div class="space-y-6">
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 grid gap-4 md:grid-cols-2">
                        ...
                        <div class="rounded-xl bg-slate-50 p-4">
                            <p class="text-xs font-bold uppercase text-slate-400">Statut CRM initial</p>
                            <p class="mt-1 text-sm font-medium text-slate-800">
            ...
            <aside class="space-y-6">
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-4 rounded-xl bg-slate-50 p-4 text-sm">
                        ...
                        <p class="mt-1 font-medium text-slate-800">{{ $client->user?->email ?? $client->email }}</p>
                    </div>

                    <div class="mt-4 rounded-xl bg-slate-50 p-4 text-sm">
                        <p class="text-xs font-bold uppercase text-slate-400">Rôle</p>
                        <p class="mt-1 font-medium text-slate-800">{{ $client->user?->role ?? 'client' }}</p>
                    </div>
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <a href="{{ route('commercial.clients.edit', $client) }}"
                        class="mt-4 inline-flex h-12 w-full items-center justify-center rounded-xl border border-blue-200 bg-blue-50 px-4 text-sm font-bold text-blue-700 hover:bg-blue-100">
                        Modifier le dossier
                    </a>
