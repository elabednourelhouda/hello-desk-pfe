        ...
        <form method="POST"
            ...
            <section>
                ...
                <div class="mt-5 grid gap-5">
                    <div>
                        <label class="mb-2 block text-sm font-semibold text-slate-700">Informations de facturation</label>
                        <textarea name="billing_info" rows="3"
                                  class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm shadow-sm focus:border-[#284625] focus:ring-[#284625]">{{ old('billing_info', $client->billing_info) }}</textarea>
                    </div>

                    <div>
                        <label class="mb-2 block text-sm font-semibold text-slate-700">Notes dossier légal</label>
                        <textarea name="legal_file_notes" rows="3"
                                  class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm shadow-sm focus:border-[#284625] focus:ring-[#284625]">{{ old('legal_file_notes', $client->legal_file_notes) }}</textarea>
                    </div>

                    <div>
                        <label class="mb-2 block text-sm font-semibold text-slate-700">Notes internes</label>
