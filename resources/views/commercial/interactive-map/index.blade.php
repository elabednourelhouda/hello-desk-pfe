    ...
    <div class="mx-auto max-w-7xl px-6 py-8">
        ...
        @if(isset($hasCommercialScope) && ! $hasCommercialScope)
            <div class="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-800">
                Vous n’avez aucune affectation active. La carte interactive sera disponible après votre affectation à un campus ou à un étage.
            </div>
        @endif
                        ...
                        <div class="grid min-h-[460px] grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-4">
                            @foreach($spaces as $space)
                                ...
                                <button type="button"
                                        ...
                                        data-reserve-url="{{ $canReserve ? route('commercial.reservations.create', ['space_id' => $space->id]) : '' }}"
