...
@section('title', 'Réclamations - Espace commercial')
            ...
            <div class="grid gap-0 lg:grid-cols-[1.35fr_0.65fr]">
                ...
                <div class="bg-white p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('commercial.complaints.index', ['status' => 'new']) }}"
                        ...
                        <a href="{{ route('commercial.complaints.index', ['status' => 'in_progress']) }}"
                        class="rounded-2xl border p-4 transition hover:-translate-y-0.5 hover:shadow-md
                        ...
                        <a href="{{ route('commercial.complaints.index', ['status' => 'resolved']) }}"
                        class="rounded-2xl border p-4 transition hover:-translate-y-0.5 hover:shadow-md
                        ...
                        <a href="{{ route('commercial.complaints.index', ['priority' => 'urgent']) }}"
                        class="rounded-2xl border p-4 transition hover:-translate-y-0.5 hover:shadow-md
...
<section class="mt-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
    ...
    <form method="GET"
          action="{{ route('commercial.complaints.index') }}"
