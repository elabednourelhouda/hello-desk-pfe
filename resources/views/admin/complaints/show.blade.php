...
@section('title', 'Détail réclamation - Administration')
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 space-y-4 text-sm">
                        ...
                        @if($complaint->reservation)
                            <a href="{{ route('admin.reservations.show', $complaint->reservation) }}"
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 space-y-4 text-sm">
                        ...
                        @if($complaint->contract)
                            <a href="{{ route('admin.contracts.show', $complaint->contract) }}"
