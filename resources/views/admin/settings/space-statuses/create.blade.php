...
@section('title', 'Ajouter un statut d’espace - Administration')
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-2xl px-6 py-8">
        ...
        <h1 class="mt-1 text-3xl font-bold text-gray-900">Ajouter un statut d’espace</h1>

        <form method="POST"
              action="{{ route('admin.settings.space-statuses.store') }}"
