...
@section('title', 'Modifier un site - Administration')
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-2xl px-6 py-8">
        ...
        <h1 class="mt-1 text-3xl font-bold text-gray-900">Modifier « {{ $site->name }} »</h1>

        <form method="POST"
              action="{{ route('admin.settings.sites.update', $site) }}"
            ...
            <div class="grid gap-5">
                ...
                <div>
                    ...
                    <textarea name="description"
                              rows="3"
                              class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm shadow-sm focus:border-[#284625] focus:ring-[#284625]">{{ old('description', $site->description) }}</textarea>
