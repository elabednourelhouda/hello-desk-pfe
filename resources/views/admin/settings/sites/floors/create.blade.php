...
@section('title', 'Ajouter un étage - ' . $site->name)
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-2xl px-6 py-8">
        ...
        <h1 class="mt-1 text-3xl font-bold text-gray-900">Ajouter un étage</h1>

        <form method="POST"
              action="{{ route('admin.settings.sites.floors.store', $site) }}"
            ...
            <div class="grid gap-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        @error('level')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Utilisé pour trier les étages (0 = rez-de-chaussée).</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Identifiant technique utilisé par la carte interactive pour repérer ce plan d’étage.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description"
                              rows="3"
                              placeholder="Description interne (facultatif)"
