...
@section('title', 'Modifier un type d’espace - Administration')
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-2xl px-6 py-8">
        ...
        <p class="text-sm font-medium text-[#284625]">
            ...
            /
            <a href="{{ route('admin.settings.space-types.index') }}" class="hover:underline">Types d’espaces</a>
        </p>
        <h1 class="mt-1 text-3xl font-bold text-gray-900">Modifier « {{ $spaceType->name }} »</h1>

        <form method="POST"
              action="{{ route('admin.settings.space-types.update', $spaceType) }}"
            ...
            <div class="grid gap-5">
                ...
                <div>
                    ...
                    <textarea name="description"
                              rows="3"
                              class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm shadow-sm focus:border-[#284625] focus:ring-[#284625]">{{ old('description', $spaceType->description) }}</textarea>
                ...
                <label class="flex items-center gap-3">
                    <input type="checkbox"
                           name="is_active"
                           value="1"
                           {{ old('is_active', $spaceType->is_active) ? 'checked' : '' }}
