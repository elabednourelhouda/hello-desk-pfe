...
@section('title', 'Modifier ' . $contactType->name . ' - Administration')
...
<div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-2xl px-6 py-8">
        ...
        <h1 class="mt-1 text-3xl font-bold text-gray-900">Modifier « {{ $contactType->name }} »</h1>

        <form method="POST"
              action="{{ route('admin.settings.contact-types.update', $contactType) }}"
            ...
            <div class="grid gap-5">
                ...
                <div>
                    ...
                    <input type="text"
                           name="code"
                           value="{{ old('code', $contactType->code) }}"
                           required
                           placeholder="Ex: sms"
                           class="h-12 w-full rounded-xl border border-gray-300 px-4 text-sm shadow-sm focus:border-[#284625] focus:ring-[#284625]">
                ...
                <label class="flex items-center gap-3">
                    <input type="checkbox"
                           name="is_active"
                           value="1"
                           {{ old('is_active', $contactType->is_active) ? 'checked' : '' }}
