            ...
            <div class="space-y-6">
                ...
                <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div class="mb-5 flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Résumé du besoin exprimé lors du premier contact avec le prospect.
                            </p>
                        </div>
                    ...
                    {{-- 
                        ...
                        For now, we only show the initial need to keep the prospect dossier simple.

                        Later, if Hello Desk needs a deeper CRM history, we can activate a hidden/future
